...
import { isTokenAndIsValid, setAuthToken } from "@/utils/authToken"
...
export default function SigninForm() {
  ...
  const { mutate, data, isSuccess, isPending } = usePostQuery('auth');
    ...
    return (
      <div className="flex flex-col gap-6 items-center">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button type="submit" className="grow" loading={isPending}>
                      Connexion
                    </Button>
                  </div>
        ...
        <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
          En vous connectant , vous approuvez <a href="#">nos conditions d'utilisation</a>{" "}
          et <a href="#">nos mentions légales</a>.
        </div>
      </div>
    )
  }
