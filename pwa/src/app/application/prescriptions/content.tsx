...
const Row = ({ data, lastElementRef }: {
	...
	const { data: ownerData, isLoading: isLoadingOwners } = useGetIRI(data.owner ? data.owner : "");
	const { data: patientData, isLoading: isLoadingPatients } = useGetIRI(data.patient ? data.patient : "");
