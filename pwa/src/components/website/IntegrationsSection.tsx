...
import { Ambulance, CalendarDays, HeartPulse, Hospital, SoapDispenserDroplet, Stethoscope } from 'lucide-react'
import Image from 'next/image'
import picto from '../../../public/picto.svg'
                ...
                <div className="mx-auto max-w-5xl px-6">
                    <div className="aspect-16/10 group relative mx-auto flex max-w-88 items-center justify-between sm:max-w-sm">
                        ...
                        <div className="bg-linear-to-b from-muted-foreground/15 absolute inset-0 flex aspect-square items-center justify-center rounded-full border-t to-transparent to-25%">
                            ...
                            <IntegrationCard className="absolute top-0 -translate-y-1/2 text-primary">
                                <CalendarDays />
                            </IntegrationCard>
                            <IntegrationCard className="translate-x-1/6 absolute right-0 top-1/4 -translate-y-1/4 text-secondary">
                                <Hospital />
                            </IntegrationCard>
                        </div>
                        <div className="bg-linear-to-b from-muted-foreground/15 absolute inset-16 flex aspect-square scale-90 items-center justify-center rounded-full border-t to-transparent to-25%">
                            <IntegrationCard className="absolute top-0 -translate-y-1/2 text-secondary">
                                <Stethoscope />
                            </IntegrationCard>
                            <IntegrationCard className="absolute left-0 top-1/4 -translate-x-1/4 -translate-y-1/4 text-primary">
                                <HeartPulse />
                            </IntegrationCard>
                            <IntegrationCard className="absolute right-0 top-1/4 -translate-y-1/4 translate-x-1/4 text-primary">
                                <Ambulance />
                            </IntegrationCard>
                        </div>
                    ...
                    <div className="bg-linear-to-t from-background relative z-20 mx-auto mt-12 max-w-lg space-y-6 from-55% text-center">
                        <h2 className="text-balance text-3xl font-semibold md:text-4xl">Notre mission</h2>
                        <p className="text-muted-foreground">Simplifier et coordonner les soins à domicile pour garantir à chaque personne un parcours de santé clair, organisé et digne.</p>
                    </div>
                </div>
            </div>
        </section>
